...
//        }
//        std::vector<std::string> whole_line = ics::split(combine, " ");
//        for (int x = 0; x < whole_line.size()-2; ++x){   //whole_line.size()
//            WordQueue wordQueue;
//            FollowSet followSet;
//            int n;
//            for(n=0; n<os; n++){
//                wordQueue.enqueue(whole_line[x+n]);
//            }
//            followSet.insert(whole_line[x+n]);
//            corpus[wordQueue].insert(whole_line[x+n]);
//        }
//    }
...
//	for (ics::ArrayQueue<std::string>::Iterator x = a.first.begin(); x != a.first.end(); x++)
//	{
//        for (ics::ArrayQueue<std::string>::Iterator y = b.first.begin(); y != b.first.end(); y++) {
//            if (*x == *y) {
//                continue;
//            }
//            else {
...
//    int mini = 0;
//    int max = 0;
//    mini = sorted.peek().second.size();
//    max = sorted.peek().second.size();
//    for (auto kv : sorted)
//    {
//        count++;
//        if (kv.second.size() < mini)
//        {
//            mini = kv.second.size();
//        }
//        else if (kv.second.size() > max)
//        {
//            max = kv.second.size();
//        }
//    }
//    std::cout << "Corpus has "<< count << " Entries" << std::endl;
//    for (auto k : sorted)
//    {
//        std::cout << "  " << k.first << " -> " << k.second << std::endl;
//    }
//    std::cout << "Corpus has "<< count << " Entries" << std::endl;
//    std::cout << "min/max = "<< mini << "/" << max << std::endl;
//}
//
//
...
//    WordQueue result;
//    for(auto word: start){
//        keyholder.enqueue(word);
//        result.enqueue(word);
//    }
//    for(int i=0; i<count; i++){
//        result.enqueue(random_in_set(corpus[keyholder]));
//        keyholder.clear();
//        keyholder.enqueue_all(result);
//      while (keyholder.size() > start.size())
//      {
//          keyholder.dequeue();
//      }
//    }
...
//        std::string mystr;
//        int os;
//        std::cout << "Enter an order statistic[2]: ";
//        std::getline (std::cin,mystr);
//        std::stringstream(mystr) >> os;
//        ics::safe_open(input_file, "Enter a file to process", "wginput1.txt");
//        Corpus c = read_corpus(os, input_file);
//        std::cout << std::endl;
//        print_corpus(c);
//        std::cout<< std::endl << "Enter " << os << " words to start with " << std::endl;
//        WordQueue userInputQueue;
//        for(int n=1; n<=os; n++){
//            std::string user_input;
//            std::cout << "Enter word " << n << ": ";
//            std::cin >> user_input;
//            userInputQueue.enqueue(user_input);
//        }
//        WordQueue anotha;
//        int num;
//        std::cout << "Enter # of words to generate: ";
//        std::cin >> num;
//        anotha = produce_text(c, userInputQueue, num);
//        std::cout<< "Random text = " << anotha << std::endl;
