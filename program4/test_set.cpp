...
//int test_size  = 50000; // ics::prompt_int ("Enter large scale test size");
//int trace      = false; // ics::prompt_bool("Trace large scale test",false);
//int speed_size = 50000; // ics::prompt_int ("Enter large scale speed test size");


int test_size  = 10000; // ics::prompt_int ("Enter large scale test size");
int trace      = false; // ics::prompt_bool("Trace large scale test",false);
int speed_size = 10000; // ics::prompt_int ("Enter large scale speed test size");
